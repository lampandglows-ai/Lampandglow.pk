    ...
    <section className="w-full min-h-screen bg-[#fafafa]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        ...
        <div className="mt-12 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          {/* Left — Form */}
          <div>
            <h3 className="text-sm font-bold text-stone-800">Send us an email</h3>
          ...
          <div className="lg:pl-4">
            <div className="rounded-xl border border-stone-100 bg-white p-6 sm:p-8 shadow-sm">
              <h3 className="text-sm font-bold text-stone-800">Live Help</h3>
              ...
              <div className="mt-8 space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <span className="text-sm text-stone-600 leading-relaxed">
                    45 West Road<br />
                    Newcastle Upon Tyne, NE4 9PX<br />
                    United Kingdom
                  </span>
                </div>
              </div>
