...
export default function CollectionsPage() {
  ...
  return (
    <section className="w-full min-h-screen bg-[#FAFAF8]">
      <div className="py-12 sm:py-16">
        ...
        <div className="mt-8 text-center">
          <h1 className="text-2xl sm:text-3xl font-semibold tracking-tight text-[#5A2D0C]">Collections</h1>
          ...
          <div className="mt-12 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 sm:gap-5 px-2">
            {categories.map((category) => (
              <button
                ...
                className="w-full group product-card relative overflow-hidden rounded-2xl bg-white shadow-lg ring-1 ring-[#E5E5E5] text-left transition-all duration-300 ease-out hover:-translate-y-1.5 hover:shadow-[0_10px_30px_rgba(0,0,0,0.1)] active:scale-[0.98] motion-reduce:transform-none motion-reduce:transition-none"
              >
